...
export const paths = {
  ...
  auth: {
    ...
    jwt: {
      ...
      superAdminLogin: `${ROOTS.AUTH}/super-admin-jwt/super-admin-login`,
      superAdminRegister: `${ROOTS.AUTH}/super-admin-jwt/super-admin-register`,
      superAdminRegisterOtpVerification: `${ROOTS.AUTH}/super-admin-jwt/super-admin-otp-verification`,
      superAdminLoginOtpVerification: `${ROOTS.AUTH}/super-admin-jwt/super-admin-login-otp-verification`,
      superAdminForgotPassword: `${ROOTS.AUTH}/super-admin-jwt/super-admin-forgot-password`,
      superAdminForgotPasswordOtpVerification: `${ROOTS.AUTH}/super-admin-jwt/super-admin-forgot-password-otp-verification`,
    },
    firebase: {
