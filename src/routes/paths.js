...
export const paths = {
  ...
  auth: {
    ...
    jwt: {
      ...
      superAdminLogin: `${ROOTS.AUTH}/jwt/super-admin-login`,
      superAdminRegister: `${ROOTS.AUTH}/jwt/super-admin-register`,
      superAdminRegisterOtpVerification: `${ROOTS.AUTH}/jwt/super-admin-otp-verification`,
      superAdminLoginOtpVerification: `${ROOTS.AUTH}/jwt/super-admin-login-otp-verification`,
      superAdminForgotPassword: `${ROOTS.AUTH}/jwt/super-admin-forgot-password`,
      superAdminForgotPasswordOtpVerification: `${ROOTS.AUTH}/jwt/super-admin-forgot-password-otp-verification`,
    },
    firebase: {
